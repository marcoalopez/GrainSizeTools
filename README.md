...
- It allows loading and extracting data from txt and csv files generated by the ImageJ or similar applications.
...
***Two-step method***  
Lopez-Sanchez MA and Llana-Fúnez. An extension of the Saltykov method to quantify 3D grain size distributions in mylonites. *Available soon*
