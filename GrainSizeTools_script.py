...
def derive3D(diameters, numbins=10, set_limit=None, fit=False, initial_guess=False):
    ...
    References
    ----------
    | Saltykov SA (1967) doi:10.1007/978-3-642-88260-9_3
    | Sahagian and Proussevitch (1998) J. Vol. Geotherm. Res. doi:10.1029/95JB0250
    | Lopez-Sanchez and Llana-Funez (2016) J. Struc. Geol. doi:10.1016/j.jsg.2016.10.00
    ...
    set_limit: integer or float (positive)
...
def Saltykov_plot(left_edges, freq3D, binsize, mid_points, cdf_norm):
    ...
    i)  a frequency plot
    ii) a volume-weighted cumulative frequency plot
    """
...
def calc_freq_grainsize(diameters, binsize, plot='freq'):
    ...
    of modal interval, and Gaussian kernel density estimation peak and call the
...
def Saltykov(freq, bin_edges, binsize, mid_points, normalize=True):
    ...
    if normalize is True:
        ...
        # normalize such that the integral over the range is one
        freq_norm = freq_norm / binsize
        return freq_norm
