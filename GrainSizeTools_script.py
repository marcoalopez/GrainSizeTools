...
#mpl.rcParams['font.family'] = 'Helvetica Neue'  # uncomment this line to set the font you want in the plots
mpl.rcParams['xtick.labelsize'] = 14.
mpl.rcParams['ytick.labelsize'] = 14.


def extract_areas(file_path, type = 'txt'):
    ...
    if type == 'txt':
        ...
        return extract_areas(file_path, type = 'csv')
...
#        print(' Covariance matrix:\n', covm)
        ...
        # Generate the plot
        return plot_3D_LSmethod(left_edges, freq3D, binsize, mid_points, freq3D, xgrid, best_fit, fit_error)
...
def plot_2Ddata(diameters, binList, xgrid, y_values, y_max, x_peak, mean_GS,
                median_GS, intValues, cumulativeAreas, h, weightedMean):
...
def plot_3D_LSmethod(left_edges, freq3D, binsize, mid_points_corrected,
                     freq3D_corrected, xgrid, best_fit, fit_error):
    """ Generate a plot using the two-step method.
...
print(' ')
print('Welcome to the GrainSizeTools script v. 1.1.1')
