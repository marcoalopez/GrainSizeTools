...
The code has been written to run on both versions. If you run into any problem using the script with either version please let me know (see an email address here: http://marcoalopez.github.io/ ). Feedback from users is always welcome and important to develop a better script.
