...
-------------
  ...
  * [Getting started: A (comprehensive) step-by-step tutorial](https://github.com/marcoalopez/GrainSizeTools/blob/master/DOCS/brief_tutorial.md)
    ...
    * [Using the script to visualize and estimate the grain size](https://github.com/marcoalopez/GrainSizeTools/blob/master/DOCS/brief_tutorial.md#using-the-script-to-visualize-and-estimate-the-grain-size-features)
      ...
      * [Obtaining an unidimensional value of grain size](https://github.com/marcoalopez/GrainSizeTools/blob/master/DOCS/brief_tutorial.md#obtaining-an-unidimensional-value-of-grain-size-paleopiezowattmetry-studies)
